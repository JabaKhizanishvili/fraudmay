            ...
            <div id="button-trigger" class="card card card-default scrollspy">
                ...
                <div class="card-content">
                    <a class="btn-floating btn-large primary-text gradient-shadow compose-email-trigger "
                       href="{{locale_route('user.create')}}">
                        <i class="material-icons">add</i>
                    </a>
                    <h4 class="card-title mt-2">@lang('admin.user')</h4>
                    <div class="row">
                        <div class="col s12">
                            <form class="mr-0 p-0">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <select class="form-control" name="status" onchange="this.form.submit()">
                                                ...
                                                <option
                                                    value="waiting" {{Request::get('status') === 'waiting' ? 'selected' :''}}>@lang('admin.waiting')</option>
                                                <option
                                                    value="approved" {{Request::get('status') === 'approved' ? 'selected' :''}}>@lang('admin.approved')</option>
                                                <option
                                                    value="rejected" {{Request::get('status') === 'rejected' ? 'selected' :''}}>@lang('admin.rejected')</option>
                                            </select>
                                        </th>
                                        <th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($user->status=="waiting")
                                                        <span class="blue-text">@lang('admin.waiting')</span>
                                                    @elseif($user->status=="rejected")
                                                        <span class="red-text">@lang('admin.rejected')</span>
                                                    @else
                                                        <span class="green-text">@lang('admin.approved')</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td>{{$user->email}}</td>
                                                <td>
                                                    <a href="{{locale_route('user.show',$user->id)}}">
